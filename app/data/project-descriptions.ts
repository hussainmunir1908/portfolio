...
export const PROJECT_DESCRIPTIONS: Readonly<Record<string, string>> = {
    ...
    "virtualgpu":
        "VirtualGPU Simulator is an interactive visualization tool designed to demystify parallel processing. It brings complex GPU architectures to life directly in the browser, offering real-time insights into thread execution and memory management. Built for performance and clarity, the simulator translates intricate hardware behaviors into an intuitive and responsive visual experience.",
};
