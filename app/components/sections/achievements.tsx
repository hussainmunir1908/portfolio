...
import { Award, BadgeCheck, Zap, GraduationCap } from "lucide-react";
...
const achievements = [
    {
        ...
        description: "Awarded the highest academic distinction at GIKI 2 semesters back to back.",
        year: "2026",
    ...
    },
    {
        ...
        description: "Earned the \"Programming with JavaScript\" certification from Meta, validating industry-standard expertise in React.js and modern software engineering.",
        year: "2025",
    ...
    },
    {
        ...
        description: "Engineered \"Khata,\" a real-time financial ledger, within a high-pressure 24-hour sprint, focusing on secure data synchronization and fluid UI.",
        year: "2026",
        category: "Innovation"
    },
    {
        icon: GraduationCap,
        title: "A-Grade Engineering",
        description: "Achieved straight A-grades in core disciplines including Microprocessor Interfacing, Operating Systems, and Signals & Systems.",
        year: "2023 – 2026",
        category: "Technical"
    }
];
