...
export default function Contact() {
    ...
    const socialLinks = [
        { name: "GitHub", icon: Github, url: "https://github.com/hussainmunir1908" },
        { name: "LinkedIn", icon: Linkedin, url: "https://linkedin.com/in/hussainmunir1908" },
    ];

    const copyEmail = (e: React.MouseEvent) => {
        e.preventDefault();
        navigator.clipboard.writeText("hussain19082005@gmail.com");
        setCopied(true);
            ...
            <div className="max-w-[1920px] mx-auto px-4 sm:px-6 md:px-12 lg:px-20 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                    ...
                    <div className="w-full h-full flex flex-col justify-center lg:pt-12">
                        <a 
                            ref={emailRef}
                            href="mailto:hussain19082005@gmail.com"
